...
class ExperimentListScreen extends StatelessWidget {
  ...
  const ExperimentListScreen({Key? key, this.workspaceId}) : super(key: key);
                  ...
                  Row(
                    children: [
                      ...
                      Expanded(
                        child: InkWell(
                          onTap: () {
                            Navigator.pushNamed(context, AppRoutes.experimentCreate,
                    ...
                    child: experiments.isEmpty
                        ...
                        : ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return InkWell(
                                onTap: () {
                                  experimentProvider.selectExperiment(experiment.id);
                                  Navigator.pushNamed(
                                    context, 
