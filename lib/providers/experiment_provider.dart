...
class ExperimentProvider with ChangeNotifier {
  ...
  String _generateAIResponse(String userMessage, String assistantId) {
    ...
    // 특정 메시지 유형에 대한 응답
    if (userMessage.toLowerCase().contains('what') || userMessage.toLowerCase().contains('how')) {
    ...
    } else if (userMessage.toLowerCase().contains('show') || userMessage.toLowerCase().contains('get')) {
      // SQL 관련 질문에 대한 응답
